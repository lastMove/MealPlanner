...
router.put('/users/:id/addFriend/:friend_id').to({controller: 'Users', action:'addFriend'});
router.get('/users/:id/friends').to({controller:'Users', action:'listFriends'});

router.resource('dishes');
router.resource('restaurants');
router.resource('meetings');
router.resource('orders');
router.resource('order_lines');
router.resource('tests');
router.resource('date:_datetimes');
