...
*/
  ...
  this.addFriend = function(req, resp, params)
  {
    var self = this;
    ...
    geddy.model.User.first(params.id, function(err, user)
    {
      ...
      geddy.model.User.first(params.friend_id, function(err, friend)
      {
        if (err)
          throw err;
        if (!friend)
          ...
          user.save(function (err, data) {
           if (err)
                throw err;     
          self.respond({"friend":friend});
            });
    });
    });
  }
  this.listFriends = function(req, resp, params)
  {
    var self = this;
    geddy.model.User.first(params.id, function(err, user)
    {
